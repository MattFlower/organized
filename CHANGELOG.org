* 0.5.2
  * Tighten up tags regex, it was matching far too much.  Now I only match the characters from orgmode ()
  * Rethink bold / italics support.  Now it's:
    * *italics*
    * **bold**
    * ***bold italics***
    * ~~strikeout~~
  ...
  * Added toolbar buttons for italics and strikethrough
